package com.xfhy.junkcode.task

import com.sun.xml.bind.v2.TODO
import com.xfhy.junkcode.ext.JunkCodeConfig
import com.xfhy.junkcode.template.ManifestTemplate
import com.xfhy.junkcode.template.ResTemplate
...
//todo 还可以做的事情 :
// 1. 将drawable的内容随机一点,不写固定内容. 比如生成shape,各种solid,corners,gradient的组合
// 2. 在Activity布局中生成多种随机的布局,然后背景可以使用上面的drawable,然后文字可以使用动态生成的string字符串
// 3. 在代码里面生成的那些方法,可以给很多button设置点击事件,然后调用该方法.
